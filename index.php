...
if (!file_exists('Config.json')) {
  file_put_contents('Config.json', '{"Timeprofile":0,"Timename":0,"Timebio":0,"Turnbot":1,"Markread":0,"Typing":0,"Online":0,"Poker":0,"Enemy":0}');
}
define('MADELINE_BRANCH', 'deprecated');
include "madeline.php";
	function closeConnection($message = "Self Is Running 🇮🇷 
")
{
